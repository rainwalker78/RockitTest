<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EQInventory.ascx.cs" Inherits="Rockweb.Blocks.Crm.EQInventory" ViewStateMode="Enabled" EnableViewState="true" %>
