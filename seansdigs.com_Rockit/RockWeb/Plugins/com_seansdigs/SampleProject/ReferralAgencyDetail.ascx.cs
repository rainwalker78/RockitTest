...
namespace RockWeb.Plugins.com_seansdigs.SampleProject
{
    /// <summary>
    /// Displays the details of a Referral Agency.
    /// </summary>
    [DisplayName( "Referral Agency Detail" )]
    [Category( "com_seansdigs > Sample Project" )]
    ...
    public partial class ReferralAgencyDetail : Rock.Web.UI.RockBlock
    {
        ...
        protected override void OnInit( EventArgs e )
        {
            ...
            dvpAgencyType.DefinedTypeId = DefinedTypeCache.Get( com.seansdigs.SampleProject.SystemGuid.DefinedType.REFERRAL_AGENCY_TYPE.AsGuid() ).Id;
